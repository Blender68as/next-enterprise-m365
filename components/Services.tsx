      ...
      <div className="cards">
        <div className="card">
          ...
          <div className="extra-info">
            ...
            <p>
              Einrichtung eines neuen Microsoft 365-Tenants, grundlegende Identity und Security-Konfiguration (Entra ID
              ehem. AD, MFA). Migration des bestehenden E-Mail-Servers zu Exchange Online, Einrichtung von OneDrive für
              Benutzer. Optional: Übernahme bestehender Daten (PST-Import, File-Share zu OneDrive).
            </p>
            <br />
        ...
        <div className="card">
          ...
          <p>Implementierung von Microsoft Teams und SharePoint für modernes Intranet und optimierte Kommunikation.</p>
          <div className="extra-info">
            <h3>Beschreibung & Umfang</h3>
            <p>
        ...
        <div className="card">
          ...
          <div className="extra-info">
            ...
            <p>
              ...
              Access), Multi-Faktor-Authentisierung überall, Mail-Verschlüsselung bzw. Sensibilisierungsklassifikationen
              (Azure Information Protection) für vertrauliche Daten. <br />
            ...
            <p>
              ...
              kontrolliert und nachweisbar compliant). Reduziertes Risiko von Datenschutzvorfällen oder Cyberangriffen.
              Durch Verschlüsselung und restriktives Rechtemanagement bleiben sensible Informationen geschützt​, ohne
              dass die Nutzer auf Komfort verzichten müssen. Eine solide Compliance begünstigt letztlich auch die
        ...
        <div className="card">
          ...
          <div className="extra-info">
            ...
            <p>
              ...
              Rechnungsfreigabe, Urlaubsantrag, Bürgeranfrage-Weiterleitung). Umsetzung als digitaler Workflow mit Power
              Automate; bei Bedarf Entwicklung einer einfachen Power App für Eingaben oder mobile Nutzung. Integration
              mit bestehenden Fachverfahren oder Datenbanken via Standard-Konnektoren, sofern möglich. Übergabe von
              Dokumentationen und Schulung ausgewählter Key-User zur Pflege der Workflows.
            </p>
            <br />
            <h3>Mehrwert für die Behörde</h3>
            <p>
        ...
        <div className="card">
          ...
          <div className="extra-info">
            ...
            <p>
              ...
              Zusatzkosten für Copilot), Einrichtung und Konfiguration der KI-Dienste in einem sicheren Rahmen (ggf. mit
              Test-Mandanten und Dummy-Daten). Auswahl konkreter Anwendungsfälle – z.B. Copilot in Word für Textentwürfe
              oder in Teams für Meeting-Zusammenfassungen – und begleitete Tests mit einer kleinen Gruppe von
              Mitarbeitern. Workshop zu KI-Ethik & Datenschutz: Dos and Don’ts bei der Nutzung von KI in der Behörde.
              Erfolgskontrolle und Empfehlung für Roll-out.
            </p>
            <br />
            <h3>Mehrwert für die Behörde</h3>
            <p>
              Die Behörde kann praxisnah erproben, welchen Nutzen KI-Werkzeuge bieten, ohne gleich flächendeckend
              Lizenzen zu kaufen. Frühzeitige Erfahrungen verschaffen einen Wissensvorsprung (man ist „vorne dabei“ bei
              neuen Technologien). Mitarbeiter werden an produktive KI-Nutzung herangeführt und Ängste abgebaut. Bei
              Erfolg kann die Lösung auf mehr Nutzer ausgeweitet werden, was mittelfristig zu erheblichen
        ...
        <div className="card">
          ...
          <div className="extra-info">
            <h3>Beschreibung & Umfang</h3>
            <p>
              Maßgeschneiderte Entwicklung von individuellen Anwendungen unter Nutzung von Microsoft-Technologien. Dies
              kann zum Beispiel die Entwicklung spezifischer Portale, maßgeschneiderter Verwaltungs-Apps oder
